...
# Backports from upstream release/2.30 branch
# SELinux policy fixes
Patch1001:      1001-data-selinux-allow-messages-from-policykit.patch
Patch1002:      1002-data-selinux-bump-policy-version-to-0.0.13.patch
Patch1003:      1003-data-selinux-add-policykit_dbus_chat.patch
# snap-exec fixes
Patch1101:      1101-dirs-check-if-distro-is-like-fedora-when-picking-pat.patch
Patch1102:      1102-cmd-snap-use-distro-snap-exec-when-running-under-cla.patch
